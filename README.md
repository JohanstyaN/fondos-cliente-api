...
- Implementar monitoring con CloudWatch Alarms
...
3. Abre un [Issue](https://github.com/TU_USUARIO/fondos-cliente-api/issues) en GitHub

**Stack Utilizado**: AWS ECS Fargate, DynamoDB, SNS, CloudWatch, React, FastAPI, Docker, CloudFormation
```
